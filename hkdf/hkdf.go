...
//
// It stretches a secret that is already high entropy, a shared secret or a
// file key, into one or more keys bound to a context string. It is not a
// password hash, the argon2 package is the one for that.
package hkdf
...
//
// The pseudorandom key should have been generated by Extract, or be a uniformly
